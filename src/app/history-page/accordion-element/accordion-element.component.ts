...
export class AccordionElementComponent{
  ...
  jason_img: string = "jason_profile.webp";
  jason_header: string = "Jason";
  jason_title: string ="Lead Consultant";
  jason_body_0: string = "Jason stammt aus Frankfurt am Main und studierte Betriebswirtschaftslehre mit dem Schwerpunkt Unternehmensführung. Während seines Studiums arbeitete er als Werkstudent bei einem internationalen Beratungsunternehmen, wo er seine Leidenschaft für Consulting entdeckte.";
  jason_body_1: string = "Nach dem Abschluss seines Studiums verbrachte er zwei Jahre in einem Start-up, in dem er Prozesse optimierte und erste Projekte leitete. Diese Erfahrung machte ihn zu einem gefragten jungen Berater. Mit dem Ziel, in einem innovativen und dynamischen Umfeld zu arbeiten, war er einer der ersten, der sich dem Team der MF-Consulting GmbH anschloss. Seit sechs Jahren leitet Jason den damals neue geschaffenen Bereich European Consulting & Acquisition"

  felix_img: string ="felix_profile.webp";
  ...
  janina_img: string ="janina_profile.webp";
  ...
  susanne_img: string ="susanne_profile.webp";
  ...
  edeltraut_img: string ="edeltraut_profile.webp";
